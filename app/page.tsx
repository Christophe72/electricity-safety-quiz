...
import { CheckCircle, XCircle, Zap, Shield, AlertTriangle, User, LogOut, History } from "lucide-react"
...
const questions: Question[] = [
  ...
  {
    id: 2,
    question: "Quelle est la tension considérée comme dangereuse pour l'homme ?",
  ...
  },
  {
    ...
    options: ["1 mètre", "2 mètres", "3 mètres", "Aucune prise n'est autorisée"],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ["Une fois par an", "Une fois par mois", "Une fois par semaine", "Jamais, il se teste automatiquement"],
    correctAnswer: 1,
    explanation:
...
export default function ElectricalSafetyQuiz() {
  ...
  const getScoreMessage = () => {
    ...
    if (percentage >= 80) return "Excellent ! Vous maîtrisez bien la sécurité électrique."
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {previousResults.length === 0 ? (
                <p className="text-center text-muted-foreground py-8">Aucun résultat précédent trouvé</p>
              ) : (
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card className="text-center">
            <CardHeader className="space-y-4">
              ...
              <CardDescription className="text-lg">Testez vos connaissances en sécurité électrique</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <Alert>
                ...
                <AlertDescription>
                  Ce questionnaire couvre les aspects essentiels de la sécurité électrique : prévention, urgences,
              ...
              <div className="space-y-3">
                ...
                {questions.map((question, index) => (
                  <div key={question.id} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                    ...
                    <Badge className={categoryColors[question.category]}>{categoryLabels[question.category]}</Badge>
                  </div>
                ))}
              </div>
          ...
          <CardContent className="space-y-4">
            {!showResult ? (
              <>
                ...
                <Button onClick={handleNextQuestion} disabled={selectedAnswer === null} className="w-full mt-6">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <AlertDescription className="mt-2">{question.explanation}</AlertDescription>
                </Alert>
